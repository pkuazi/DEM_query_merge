...
#         self._conn = MySQLdb.connect(host, user, passwd, db, charset=charset, cursorclass=cursors.DictCursor)
        self._conn = psycopg2.connect(host=host, port=port,user=user, password=passwd, database=db, cursor_factory=extras.DictCursor)
